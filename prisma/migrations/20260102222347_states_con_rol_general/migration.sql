/*
  ...
  - The values [PENDING,ACCEPTED] on the enum `ApplicationState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ApplicationState_new" AS ENUM ('PENDING_AS_STUDENT', 'PENDING_AS_STAFF', 'ACCEPTED_AS_STUDENT', 'ACCEPTED_AS_STAFF', 'CREATED', 'REJECTED', 'ACTIVE');
