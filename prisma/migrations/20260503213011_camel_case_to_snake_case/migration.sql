/*
  Warnings:
  - Migración editada manualmente para preservar los datos de las columnas en camelCase.
  - Se utilizan sentencias RENAME COLUMN en lugar de DROP/ADD.
*/
...
ALTER TABLE "schedules" 
  RENAME COLUMN "timeBlock" TO "time_block";
